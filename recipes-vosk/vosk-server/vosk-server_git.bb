...
DEPENDS = "python3-vosk-websocket-server python3-vosk-api openblas vosk boost"
...
do_compile () {
	# websocket-cpp
	cd websocket-cpp
	${CXX} -std=c++17 -O2 -I${STAGING_INCDIR}/vosk -lvosk -lpthread -lm -o vosk-websocket-cpp asr_server.cpp
}
